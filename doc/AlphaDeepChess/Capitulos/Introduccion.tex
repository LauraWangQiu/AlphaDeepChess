...
In Figure \ref{fig:white-king-movement-game}, the white king cannot move to $e4$ because the black king is attacking that square. When two kings are positioned close to each other, neither can move to a square adjacent to the other.
...
In Figure \ref{fig:bishop-captures-knight}, the white bishop capturing the black knight is written as $Bxc6$. If it were black's turn, the pawn on $a6$ could capture the white bishop, and it would be written as $Pxb5$ or simply $axb5$, indicating the pawn's column.
...
In Figure \ref{fig:pawn-captures-rook}, white pawn capturing and promoting in $a8$ to a queen is written as $bxa8Q$ or $bxa8=Q$.
...
In Figure \ref{fig:black-queen-checkmates}, black queen movement checkmates and it is written as $Dh4++$.
