...
static std::unordered_map<std::string, PerftEntry> perftResults = {
    ...
    {"FEN_TEST4_MIRROR",
     {"r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1",
      {1, 6, 264, 9467, 422333, 15833292, 706045033}}},
    {"FEN_STRANGEMOVES",
     {"r3k2r/p1pppp1p/N3Q3/qpP1KN2/6p1/8/Pp2p1pP/R6R w kq b6 0 2",
      {1, 44, 1777, 65325, 2613058, 91671532, 0}}}};
...
void move_generator_test()
{
    ...
    for (const auto& [key, entry] : perftResults) {
        for (size_t depth = 1; depth < entry.perftResults.size(); depth++) {
            int64_t time = 0;
            uint64_t nodes = 0U;
            ...
            if (nodes == entry.perftResults[depth]) {
                ...
                std::cout << RED_COLOR << "incorrect " << RESET_COLOR
                          << "should be: " << entry.perftResults[depth] << '\n';
            }
        }
    }
}
