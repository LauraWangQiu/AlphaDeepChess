...
\noindent In 1997, the chess engine \texttt{Deep Blue} made history by defeating the reigning world champion at the time, Garry Kasparov, marking the first time a computer had defeated a sitting world chess champion.
\vspace{1em}
...
\noindent The objectives of this projects are the following:
\begin{itemize}
...
\noindent Chess is a board game where two players who take white pieces and black pieces respectively compete to first checkmate the opponent. Checkmate occurs when the king is under thread of capture (known as check) by a piece or pieces of the enemy, and there is no legal way to escape or remove the threat.
...
\noindent Chess is a game of strategy that takes place on a chessboard with specific rules governing the movement and interaction of the pieces. This section introduces the fundamental concepts necessary to understand how chess is played.
