...
\begin{lstlisting}[breaklines=true, caption={Initialization of knight piece-square table}]
...
\begin{lstlisting}[breaklines=true, caption={Initialization of bishop attack tables}]
...
\begin{lstlisting}[breaklines=true, caption={Initialization of directions masks}]
...
\begin{lstlisting}[breaklines=true, caption={Initialization of seeds}]
...
\begin{lstlisting}[breaklines=true, caption={Code example to calculate zobrist hash of position}, label={lst:zobrist_calculate_hash}]
    /**
